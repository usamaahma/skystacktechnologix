            ...
            <div className="footer-container">
                ...
                <div className="footer-top">
                    <div className="footer-brand">
                        <img
                            ...
                            onError={(e) => {
                                e.target.src = 'https://via.placeholder.com/180x60?text=Sky+Stack+Logo';
                            }}
                        />
                        <p className="footer-tagline">
                            Elevating businesses through innovative digital solutions in Melbourne and beyond.
                        </p>
                    ...
                    <div className="footer-contact">
                        ...
                        <div className="contact-info">
                            ...
                            <div className="contact-item">
                                ...
                                <span>info@skystacktechnologiz.com</span>
                            </div>
                            <div className="contact-item">
                                <FontAwesomeIcon icon={faMapMarkerAlt} className="contact-icon" />
                                <span>123 Tech Street, Melbourne VIC 3000</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="footer-bottom">
                    <div className="copyright">
                        © {new Date().getFullYear()} Sky Stack Technologiz. All rights reserved.
                    </div>
