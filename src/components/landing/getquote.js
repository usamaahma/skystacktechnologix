      ...
      <div className="quote-content">
        ...
        <div className="partners-section">
          <p className="partners-text">
            We team up with the leading names of the industry. We have
            established a close channel with major technology brands across the
            world and it enables us to bring the best to every business, every
            time.
          </p>
