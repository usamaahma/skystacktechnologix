      ...
      <section className="di-marketing-hero">
        <div className="di-hero-container">
          <div className="di-hero-content">
            <h1>
              <span className="di-highlight">Results-Driven</span> Digital Marketing
            </h1>
          ...
          <div className="di-hero-image">
            <div className="di-analytics-dashboard">
              <div className="di-dashboard-header">
                <h3>Marketing Performance</h3>
                <div className="di-growth-badge">
              ...
              <div className="di-metric-bars">
                <div className="di-bar" style={{ height: '60%', backgroundColor: '#1E3A8A' }}></div>
                <div className="di-bar" style={{ height: '80%', backgroundColor: '#2563EB' }}></div>
                <div className="di-bar" style={{ height: '45%', backgroundColor: '#1E3A8A' }}></div>
                <div className="di-bar" style={{ height: '90%', backgroundColor: '#2563EB' }}></div>
                <div className="di-bar" style={{ height: '70%', backgroundColor: '#1E3A8A' }}></div>
              </div>
              <div className="di-metric-cards">
                <div className="di-metric-card">
                  <div className="di-metric-value">4.8x</div>
                  <div className="di-metric-label">Traffic Growth</div>
                </div>
                <div className="di-metric-card">
                  <div className="di-metric-value">63%</div>
                  <div className="di-metric-label">Lead Increase</div>
                </div>
                <div className="di-metric-card">
                  <div className="di-metric-value">2.3x</div>
                  <div className="di-metric-label">Conversion Rate</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="di-services-section">
        ...
        <div className="di-services-grid">
          <div className="di-service-card">
            <div className="di-service-icon" style={{ backgroundColor: '#1E3A8A' }}>
          ...
          <div className="di-service-card">
            <div className="di-service-icon" style={{ backgroundColor: '#2563EB' }}>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="di-results-container">
          ...
          <div className="di-results-stats">
            <div className="di-stat-item">
              <div className="di-stat-number" data-target="245">0</div>
              <div className="di-stat-label">Clients Helped</div>
            </div>
            <div className="di-stat-item">
              <div className="di-stat-number" data-target="578">0</div>
              <div className="di-stat-label">Campaigns Managed</div>
            </div>
            <div className="di-stat-item">
              <div className="di-stat-number" data-target="94">0</div>
              <div className="di-stat-label">Avg. ROI Increase</div>
            </div>
            <div className="di-stat-item">
              <div className="di-stat-number" data-target="12">0</div>
        ...
        <div className="di-testimonials-grid">
          <div className="di-testimonial-card">
            ...
            <div className="di-client-info">
              <div className="di-client-avatar"></div>
